...
node('maven') {
  ...
  stage('Deploy to Dev') {
    ...
    sh "oc patch dc tasks --patch '{\"spec\": { \"triggers\": [ { \"type\": \"ImageChange\", \"imageChangeParams\": { \"containerNames\": [ \"tasks\" ], \"from\": { \"kind\": \"ImageStreamTag\", \"namespace\": \"myproject-dev\", \"name\": \"tasks:DevCandidate-$version\"}}}]}}' -n myproject-dev"
